...
√* getDogs
    √- Fetch request for dogs 

√ * renderDog
   √ - select table body 
   √ - add the inner.html (copy and paste it from readME)
   √ - add string interpolation to the innerHTML 

√* renderDogs
    √- Iterate through the dog array the getDpgs fetch request sends back and take the local variable of the iteration and put it through renderDog
